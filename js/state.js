...
var PALETTE = ['#e0a336','#4fa3a0','#8d79d1','#d1637d','#5b93c4','#8fae4f','#c96b3f','#a688c9'];
  ...
  function defaultState(){
    ...
    return {
      ...
      dancers: dancers,
      formations: [
        {id:uid('f'), name:'Startlinie', pos: startlinie, showAxes:true},
        {id:uid('f'), name:'Kreis', pos: kreis, showAxes:true},
        {id:uid('f'), name:'Diagonale', pos: diagonale, showAxes:true}
      ],
      axes: [],
      showAxes: true,
      pairs: [],
  ...
  var playing = false, phase = 'hold', phaseStart = 0, fromIdx = 0, toIdx = 0, rafId = null, syncActive = false;
